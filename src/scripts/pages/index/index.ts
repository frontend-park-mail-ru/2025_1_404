...
export default class IndexPage extends Page {
    ...
    private addCard(offer: Offer) {
        ...
        this.cardsList.insertAdjacentHTML('beforeend', cardTemplate({id: offer.id, verified: offer.verified, address: offer.address, cardTitle, floor: offer.floor, image: offer.images[0], metroColor: offer.metroColor || '999999', metroStation: offer.metroStation || "Нет", rooms: offer.rooms, square: offer.area, totalFloors: offer.totalFloors, favorite: offer.favorite}));
    }
